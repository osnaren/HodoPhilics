...
function proceed_user(user_name, olnw) {
    ...
    setTimeout(function () {
        ...
        pgtransbot.style.visibility = 'hidden';
        //document.getElementById("mybanks").style.display = "flex";
    }, 3000);
...
var indvid = document.getElementById('india-vid');
var mybanks = document.getElementById('mybanks');
indvid.addEventListener('click', function (e) {
    indvid.classList.toggle("active");
    if (indvid.classList.contains("active")) {
        indvid.style.zIndex = "200";
        indvid.style.position = "fixed";
    } else {
        indvid.style.zIndex = "-2";
        indvid.style.position = "absolute";
    }
    console.log('india');
});
