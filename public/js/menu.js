...
function fetch_banks() {
    ...
    var to = ['Chennai', 'Delhi', 'Mumbai', 'Kolkata'];
    var from = ['Theni', 'Salem', 'Kanyakumari', 'Cochin'];
    var accno = Math.floor(Math.random() * 10000000000);
    var bno = Math.floor((Math.random() * 4));
    var fno = Math.floor((Math.random() * 4));
    var tno = Math.floor((Math.random() * 4));
    var cno = Math.floor(Math.random() * 10000000);
    accno = "HOPHI" + String(accno);
    bname.innerHTML = from[fno] + " ⇨ " + to[tno];
    acc.innerHTML = accno;
    cus.innerHTML = "C.ID : " + String(cno);
    var src = "";
    switch (tno) {
        case 0:
            src = "https://img.icons8.com/bubbles/100/000000/chennai.png";
            break;
        case 1:
            src = "https://img.icons8.com/bubbles/100/000000/new-delhi.png";
            break;
        case 2:
            src = "https://img.icons8.com/bubbles/100/000000/mumbai.png";
            break;
        case 3:
            src = "https://img.icons8.com/bubbles/100/000000/kolkata.png";
            break;
        case 4:
            src = "img/cub.png";
            break;
...
var usrModal = document.getElementById('userModal')
usrModal.addEventListener('hidden.bs.modal', function (event) {
